...
Pressing the ‘Extra’s bar’ should now reveal the Icon for Lotto5
...
the original name before the Extras bar would update. If this weren’t done
...
like restricting programs but just to encourage you to register one small
...
to use the program to it’s full ability. You will receive support via email
...
Email:	mian.gardner@btinternet.com
Web:	http://www.btinternet.com/~mian.gardner

Due to the nature of my work I do tend to change address every few years. I
am Due to move from 3 Body Road by May 2002 .When I do move I will update
...
Version Number: 		    2.10
Version Date:		            August 1999
Application Size: 		    Approx 200K
Memory Required only when running:  Approx 240K
Format: 		            Epoc32  ER3
...
V1.00 April 1999 	Psion Word Format Only
V1.10 August 1999	Improvements added for version 2.10
