RMRFRUIT Fruit Machine Arcade Game V2.00
----------------------------------------
...
Welcome to our Fruit Machine game for the EPOC 32 Series of handheld computers.

As it stands, this Shareware version is fully working, but you cannot Save games, you cannot select 'Fast' opn the reel speed and you can't win more than £100 :-)  These functions are available once you register.  Please note that registration does not involve reloading the program, but simply selecting the 'Register' menu option and typing in a registration code to release the 'lock'.

FILE DETAILS

The archive file should contain the following files:

RMRFruit.sis		The program
Readme.txt		instructions

INSTALLATION

To install the program simply double-click on the RMRFRUIT.SIS file or select the "Install New Program" option in PSIWIN (EPOC Install).  If you have the latest PSIWIN or EPOC Install then everything will happen automatically.  If you don't have these then you need to get the installation file SETUP.EXE, which can be downloaded from our Home Page.   If you are unsure, then go to http://www.rmrsoft.com/sis.htm  for a full explanation of the installation procedure.

RUNNING THE PROGRAM

Start the program by selecting the 'Extras' from the Application bar and then 'RMRFruit'.
...
This program has been allocated the RegNet Number: 2740 and this should be quoted. Again, the notification tends to get to us within 24 hours and we reply within another 24 hrs. (Note that paying by this method will involve an extra US$5 handling charge)
