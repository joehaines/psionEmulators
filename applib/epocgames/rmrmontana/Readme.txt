...
This program is an RMR Software 'badged' version of Ian Webster's Montana card game for the EPOC Series. 
...
RMRMontana.sis   The program
ReadMe.txt   English Instructions 
(plus other language README files)

Once installed. you will see the program consists of the following essential files: (all in /System/Apps/RMRMontana/)

RMRMontana.app     - The main program file
RMRMontana.mbm     - The icons used within the program
RMRMontana.aif     - The icons used in the System screen
RMRMontana.rsc     - The language resource file

And the following optional files which can be loaded as required:

RMRMontana.hlp     - Optional Help File

INSTALLATION

To install the program simply double-click on the RMRMontana.sis file or select the "Install New Program" option in PSIWIN (EPOC Install).
...
Start the program by selecting the 'Extras' from the Application bar and then 'RMRMontana'.
...
This program has been allocated the REGNET Number: 5271 and this should be quoted. Again, the notification tends to get to us within 24 hours and we reply within another 24 hrs. (Note that paying by this method will involve an extra US$5 handling charge)
