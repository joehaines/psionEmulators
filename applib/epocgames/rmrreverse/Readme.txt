...
This program is an RMR Software 'badged' version of Ian Webster's program for the EPOC Series of platforms, based on the traditional 'Othello' board game. 
...
RMRReverse.sis   The program
ReadMe.txt   Instructions 

Once installed. you will see the program consists of the following essential files: (all in /System/Apps/RMRReverse/)

RMRReverse.app     - The main program file
RMRReverse.mbm     - The icons used within the program
RMRReverse.aif     - The icons used in the System screen
RMRReverse.rsc     - The language resource file

And the following optional files which can be loaded as required:

RMRReverse.hlp     - Help File
/System/Libs/RMRShared/*.wve   -  Sound files

INSTALLATION

To install the program simply double-click on the RMRReverse.sis file or select the "Install New Program" option in PSIWIN (EPOC Install).

RUNNING THE PROGRAM

Start the program by selecting the 'Extras' from the Application bar and then 'RMRReverse'.

You can learn everything you need to about the program by playing with it and checking the effect of each MENU selection, particularly the 'Preferences' option. We have not written any separate instructions, as we believe all the information you need is in the on-line Help file. 
...
This program has been allocated the REGNET Number: 5688 and this should be quoted. Again, the notification tends to get to us within 24 hours and we reply within another 24 hrs. (Note that paying by this method will involve an extra US$5 handling charge)
