RMRFTP File Transfer Protocol Client
------------------------------------
...
INTRODUCTION
------------
Welcome to our File Transfer Protocol Client for the EPOC Series of handheld computers.

As it stands, this Shareware version is almost fully functional but doesn't support some of the menu options. Please note that registration does not involve reloading the program, but simply selecting the 'Register' menu option and typing in a registration code to release the 'lock'.

INSTALLATION
------------
To install the program simply double-click on the RMRFTP.sis file or select the "Install New Program" option in PsiWin/EPOC Install.

RUNNING THE PROGRAM
-------------------
Start the program by selecting 'Extras' from the Application bar and then selecting RMRFTP.

REGISTRATION
--------------
If you wish to register the program, you can do so by post (snail-mail), or on-line using a credit card.  The registration fee is £15 or US$25 (plus US$5 if using REGNET)
...
If you are not already signed up for PayPal it is very straightforward to join.  Just go to www.paypal.com and follow the instructions.  You even get a $5 bonus for signing up. We would also appreciate if you say that you were referred by alan@rmrsoft.com so that we get the $5 referral bonus :-)).
...
This program has been allocated the RegNet Number: 5496 and this should be quoted.  The notification tends to get to us within 12 hours and we reply as soon as possible.
