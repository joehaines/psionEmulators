Vactrac5 - Leave/Vacation Tracker
...
INTRODUCTION
------------
Welcome to our Vacation Tracker program for the EPOC Series of handheld computers.

As it stands, this Shareware version is fully-working with no disabled functions, but will allow only a limited number persons in the file. Please note that registration does not involve reloading the program, but simply typing in a registration code to release the 'lock'.
...
INSTALLATION
------------
To install the program simply double-click on the Vactrac5.sis file or select the "Install New Program" option in PsiWin/EPOC Install.
...
RUNNING THE PROGRAM
-------------------
Start the program by selecting 'Extras' from the Application bar and then selecting Vactrac5.
...
This program has been allocated the RegNet Number: 1771 and this should be quoted.  The notification tends to get to us within 12 hours and we reply as soon as possible.
