...
INTRODUCTION
------------
Welcome to our Expense Account Manager for the EPOC Series of handheld computers.

As it stands, this Shareware version is fully functional but limits you to a a few entries for each trip to enable you to try out the program before registering. Please note that registration does not involve reloading the program, but simply selecting the 'Register' menu option and typing in a registration code to release the 'lock'.

FILE DETAILS
------------
The archive file should contain the following files:

RMRExpense.sis  The program
Readme.txt       English Instructions

INSTALLATION
------------
To install the program simply double-click on the RMRExpense.sis file or select the "Install New Program" option in PsiWin (EPOC Install). If you have PsiWin/EPOC Install v2.1 or above, then everything will happen automatically. If you have an earlier version, you will need to get the installation file Setup.exe, which can be downloaded from our Home Page. If you are unsure, then go to http://www.rmrsoft.com/ and follow the link to the 'SIS' page for a full explanation of the installation procedure.

RUNNING THE PROGRAM
-------------------
Start the program by selecting 'Extras' from the Application bar and then selecting RMRExpense.

REGISTRATION
------------
If you wish to registIf you wish to register the program, you can do so by post (snail-mail), or on-line using a credit card.  The registration fee is £10 or US$15 (plus US$5 if using REGNET)
...
This program has been allocated the RegNet Number: 8776 and this should be quoted.  The notification tends to get to us within 12 hours and we reply as soon as possible.
