...
INTRODUCTION
------------
Welcome to our Fuel Consumption program for the EPOC series of platforms.

As it stands, this Shareware version is fully-working with no disabled functions, but will allow only a single vehicle and a limited number of entries (10) .  Registration will give you more unlimited entries and up to 10 vehicles.  Please note that registration does not involve reloading the program, but simply typing in a registration code to release the 'lock'.
...
INSTALLATION
------------
To install the program simply double-click on the RMRFUEL.SIS file or select the "Install New Program" option in PSIWIN (EPOC Install).
...
RUNNING THE PROGRAM
-------------------
Start the program by selecting the 'Extras' from the Application bar and then 'RMRFuel'.

All comments and, of course, registrations, gratefully received.

REGISTRATION
--------------
If you wish to register the program, you can do so by post (snail-mail), or on-line using a credit card.  The registration fee is £10 or US$15 (plus US$5 if using REGNET)
...
This program has been allocated the RegNet Number: 1364 and this should be quoted.  The notification tends to get to us within 12 hours and we reply as soon as possible.
