...
INSTALLATION
------------
To install the program simply double-click on the RMRInvest.sis file or select the "Install New Program" option in PsiWin (EPOC Install). 
...
RUNNING THE PROGRAM
-------------------
Start the program by selecting 'Extras' from the Application bar and then selecting RMRInvest.
...
This program has been allocated the RegNet Number: 4328 and this should be quoted.  The notification tends to get to us within 12 hours and we reply as soon as possible.
