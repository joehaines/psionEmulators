...
INTRODUCTION
------------
Welcome to our payslip database & analyser for the EPOC Series of handheld computers.

As it stands, this Shareware version is fully functional, but only allows 20 entries and 15 file saves, to enable you to try out the program before registering.  Please note that registration does not involve reloading the program, but simply selecting the 'Register' menu option and typing in a registration code to release the 'lock'.
...
INSTALLATION
------------
To install the program simply double-click on the RMRWAGES.SIS file or select the "Install New Program" option in PSIWIN (EPOC Install).
...
RUNNING THE PROGRAM
-------------------
Start the program by selecting the 'Extras' from the Application bar and then RMRWages.
...
This program has been allocated the RegNet Number: 9763 and this should be quoted.  The notification tends to get to us within 12 hours and we reply as soon as possible.
