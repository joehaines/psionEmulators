RMRFILE File Manager program V2.01F
----------------------------------
...
INTRODUCTION
------------
Welcome to our File Manager program for for the EPOC Series of handheld computers.

As it stands, this Shareware version is just about fully-working, with just a small 'nag screen', to enable you to try the program out before registering. Please note that registration does not involve reloading the program, but simply selecting the 'Register' menu option and typing in a registration code to release the 'lock'.

FILE DETAILS
------------
The archive file should contain the following files:

RMRFile.sis		The program install data
Readme.txt		This file

Once installed. you will see the program consists of the following essential files: (all in \System\Apps\RMRFile\

RMRFILE.app   - The main program file
RMRFILE.mbm   - The icons used within the program
RMRFILE.aif   - The icons used in the System screen
RMRFILE.rsc   - The language resource file
RMRFILE.hlp   - Help File
FOUNDFM.DLL   - Library file
LOCALFM.DLL   - Library file

INSTALLATION
------------
To install the program simply double-click on the RMRFILE.SIS file or select the "Install New Program"  option in PSIWIN (EPOC Install). If you have the latest PSIWIN or EPOC Install then everything will happen automatically. If you don't have these then you need to get the installation file SETUP.EXE, which can be downloaded from our Home Page. If you are unsure, then go to  http://www.rmrsoft.com/sis.htm for a full explanation of the installation procedure.

RUNNING THE PROGRAM
-------------------
Start the program by selecting the 'Extras' from the Application bar and then 'RMRFILE'.
...
If you are using the postal service, please send a cheque (check) (US, UK Sterling or Eurocheques only) for UKP £15 or US$25 or 50DM or 25 Euros payable to 'RMR Software' (or the equivalent in 'real money' in your actual currency) to one of the following addresses, including a stamped address envelope (or an E-Mail address) for the reply:
...
This program has been allocated the REGNET Number: 2510 and this should be quoted. Again, the notification tends to get to us within 24 hours and we reply within another 24 hrs. (Note that paying by this method will involve an extra US$5 handling charge)
