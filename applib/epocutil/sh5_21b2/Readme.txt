...
Supplied as external modules:
  backlight, button, charset, compact, contrast, du, getclip, play,
  putclip, subst, wc
...
Shell5\bin\play.opo
Shell5\bin\subst.opo
Shell5\bin\wc.opo
Extras\autoexec.bat - Enhanced sample autoexec.bat
Extras\buttons.mbm - Used by the above batch file
...
Notes about subst
-----------------
In order to use or compile the subst command, you must install
subst.opx. This is available directly from RMR Software Ltd.'s
WWW site:
          http://www.rmrsoft.com/subst.htm
